package com.xs.recycleviewapp.adapter;
...
import com.xs.recycleviewapp.R;
import com.xs.recycleviewapp.databinding.ItemTopicBinding;
import com.xs.recycleviewapp.model.BaseModel;
import com.xs.recycleviewapp.model.TopicModel;

/**
 * @version V1.0 <描述当前版本功能>
 * @author: Xs
 * @date: 2016-05-18 11:46
...
//                mBinding.cvCareview.setBackgroundResource(R.mipmap.ic_default_head);
       ...
       /*     LoadDialog.showLoadDialog(ctv.getContext(), "请求中...");
            ...
            Subscription subscription = observable.subscribe(new MySubscriber<BaseModel>(ctv.getContext()) {
                ...
                public void onNext(BaseModel baseModel) {
                    ...
                    if (baseModel.isSuccessed() && ctv != null) {
        ...
        public void onClick(View v) {
         /*   switch (v.getId()) {
                case R.id.fl_comment: {
                    ...
                    TopicCommentActivity.startActivity(v.getContext(), topicModel);
                }
                break;
